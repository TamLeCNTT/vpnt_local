  ...
  useEffect(() => {
    suyhaoService.getdata().then((res) => {
      ...
      res.data.map((item,index)=>{
        let items={ip:decryptData(item.diachi),tenthietbi:decryptData(item.tenthietbi),tenthuongmai:decryptData(item.tenthuongmai),ring:item.ring,loai:item.loai,port:item.port,nguon:item.nguon}
        listep.push(items)
      })
...
export default connect(mapStateToProps, mapDispatchToProps)(List_status_port);
