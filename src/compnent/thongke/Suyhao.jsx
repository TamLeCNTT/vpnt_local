...
const Suyhao = () => {
            ...
            await suyhaoService
              ...
              .then((res) => {
                ...
                JSON.parse(correctedJsonString).map((e, i) => {
                  ...
                  setLists((prevList) =>
                    [...prevList, newitem].sort((a, b) => a.RXpower - b.RXpower)
                  );
                });
  ...
  const getdata = (e) => {
    ...
    e.map((item, index) => {
      ...
      suyhaoService.update({ id: item.id, data: item }).then((res) => {
    ...
    <>
      ...
      <main id="cabin_list" className="main">
        <div className="container">
          ...
          {/* <Paginations
            itemsPerPage={20}
            list={lists.sort((a, b) => a.RXpower - b.RXpower)}
            getlist={getlist}
          /> */}
        </div>
      </main>
