      ...
      Object.values(e).map((item, values) => {
        ...
        try {
          if (item.tt24 == "Kém") {
            ...
            item.tt000 = listNhanVien.filter(e=>e.tennhanvien==item.tt08)[0].trungtamvienthong;
            item.tt00 = listNhanVien.filter(e=>e.tennhanvien==item.tt08)[0].tuyenkt;
          ...
          console.log(
            ...
            listNhanVien.filter((e) => e.tennhanvien == item.tt08)[0]
          );
          let tkt = "",
            ttvt = "";
          if (listNhanVien.filter((e) => e.tennhanvien == item.tt08)[0]) {
            tkt = listNhanVien.filter((e) => e.tennhanvien == item.tt08)[0].tuyenkt;
            ttvt = listNhanVien.filter((e) => e.tennhanvien == item.tt08)[0].ttvt;
          } else {
