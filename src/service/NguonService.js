...
const EMPLOYEE_API_BASE_URL = "http://10.102.20.135:5000/power/";
...
class NguonService {
  ...
  get_power_by_SW2724(ip, username, passoword) {
    return axios.get(EMPLOYEE_API_BASE_URL + "status/v2724?switch_ip=" + ip + "&user=" + username + "&password=" + passoword);
  }
  getdata() {
...
export default new NguonService();